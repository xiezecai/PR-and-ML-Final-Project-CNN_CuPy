...
from common_CuPy.layers import *
...
class DeepConvNet:
    ...
    def __init__(self, input_dim=(1, 28, 28),
        ...
        wight_init_scales = cp.sqrt(2.0 / pre_node_nums)  # 使用ReLU的情况下推荐的初始值
        ...
        self.params['W7'] = wight_init_scales[6] * cp.random.randn(64*4*4, hidden_size)
    ...
    def save_params(self, file_name="params.pkl"):
        ...
        for key, val in self.params.items():
            params[key] = cp.asnumpy(val)  # 转换为numpy数组保存
    ...
    def load_params(self, file_name="params.pkl"):
        ...
        for key, val in params.items():
            self.params[key] = cp.array(val)  # 转换为cupy数组
